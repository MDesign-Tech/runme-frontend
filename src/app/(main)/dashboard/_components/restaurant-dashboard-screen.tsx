...
const statusVariant = (status: string): 'default' | 'secondary' | 'outline' | 'destructive' => {
  if (['Ready', 'Completed', 'Paid', 'Published', 'In stock'].includes(status)) return 'default';
  if (['Preparing', 'Out for delivery', 'Low stock'].includes(status)) return 'secondary';
  ...
  return (
    <Card className="min-w-0">
      <CardHeader className="border-b">
        ...
        <CardDescription>Net sales across all service channels</CardDescription>
...
function DataTable({ screen }: Props) {
  ...
  return (
    <Card>
      <CardHeader className="border-b"><CardTitle>Latest activity</CardTitle><CardDescription>Live updates from your restaurant</CardDescription><CardAction><Button variant="ghost" size="icon-sm" aria-label="More activity options"><MoreHorizontal /></Button></CardAction></CardHeader>
